...
| Field | Value |
| --- | --- |
| State | tasks 3/8; last code commit 91a723a; next task 4 |
| Gotchas | `harness brief` requires a `title` value in addition to `path`; tasks 1-3 gate clean at low risk (no verifier) |
