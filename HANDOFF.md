...
> Live phase **implementation**, state **tasks 0/6**, last result **approved** (tasks v2).
...
> A re-run does: run the implementation phase (6 tasks; tasks approved at v2).
...
| Field | Value |
| --- | --- |
| State | tasks 3/6; last code commit 983951e; next task 4 |
