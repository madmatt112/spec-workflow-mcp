...
2. **Path Issues**
   ...
   {
     "command": "npx",
     "args": ["-y", "@madmatt112org/spec-workflow-mcp@latest", "./my-project"]
   }
   
   // ✅ Correct - absolute path
   {
     "command": "npx",
     "args": ["-y", "@madmatt112org/spec-workflow-mcp@latest", "/full/path/to/project"]
   }
   ```
...
echo -e "\n3. NPX cache:"
npx -y @madmatt112org/spec-workflow-mcp@latest --help > /dev/null && echo "✅ MCP server loads" || echo "❌ MCP server fails"
