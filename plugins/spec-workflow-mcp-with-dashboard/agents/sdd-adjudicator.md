...
description: SDD adjudicator: the escalation model. Runs the post-cap corrective pass on a document (fix or rule out every open item, write v10) and rules on task-review deadlocks. Spawned with "Read and execute the instructions in <brief>"; not for direct use.
